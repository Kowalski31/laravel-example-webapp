                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header bg-success">
                                                    <h5 class="modal-title position-absolute" id="exampleModalLabel">Update Category Name</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <form method="post" action="{{ route('update_category', $item->id) }}" id="editCategoryForm">
                                                        @csrf
                                                        <div class="mb-3 row d-flex">
                                                            <label for="categoryName" class="col-sm-2 col-form-label fw-bolder fs-6">New Name</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" name="name" class="form-control" id="categoryName" placeholder="Enter Category Name" value="{{ $item->name }}" required>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" class="btn btn-secondary" form="editCategoryForm">Update</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
